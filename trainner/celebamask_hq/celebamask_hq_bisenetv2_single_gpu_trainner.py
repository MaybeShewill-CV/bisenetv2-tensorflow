...
# @File    : celebamask_hq_bisenetv2_single_gpu_trainner.py
# @IDE: PyCharm
"""
Bisenetv2 trainner for celebamask_hq dataset
"""
import os
...
class BiseNetV2CelebamaskhqTrainer(object):
    ...
    def __init__(self):
        ...
        LOG.info('Initialize celebamaskhq bisenetv2 trainner complete')
